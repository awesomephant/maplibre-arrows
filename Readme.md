...
A [maplibre-gl-js](https://maplibre.org/maplibre-gl-js/docs/) plugin for drawing vector arrows with geographic coordinates.\
See [this blog post](https://www.maxkohler.com/posts/maplibre-arrows/) for a live demo and motivation.
